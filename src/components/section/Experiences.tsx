      ...
      <div className="themesflat-container">
          ...
          <div className="row ml-5 mt-5">
            <div className="col-md-6">
              <div className="timeline direction bg-white rounded shadow-dark padding-30 overflow-hidden">
            ...
            <div className="col-md-6">
              ...
              <div className="timeline rocket bg-white rounded shadow-dark padding-30 overflow-hidden">
