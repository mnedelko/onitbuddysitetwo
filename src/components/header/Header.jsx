...
import logoheader from '../../assets/images/logo/logoonitbuddy.png'
import logoheader2x from '../../assets/images/logo/logoonitbuddy.png'
import logodark from '../../assets/images/logo/logoonitbuddy.png'
import logodark2x from '../../assets/images/logo/logoonitbuddy.png'
import imgsun from '../../assets/images/icon/sun.png'
import avt from '../../assets/images/avatar/avt-2.jpg'

/* function Submenu(namesub){
    if(namesub === null) {
        return; 
    } else {
        namesub.map((submenu) => (
