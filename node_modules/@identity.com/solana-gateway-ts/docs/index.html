		...
		<div class="col-8 col-content">
					...
					<div class="tsd-index-content">
						...
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								...
								<li class="tsd-kind-class"><a href="classes/AssignablePublicKey.html" class="tsd-kind-icon">Assignable<wbr>Public<wbr>Key</a></li>
								...
								<li class="tsd-kind-class"><a href="classes/NetworkFeature.html" class="tsd-kind-icon">Network<wbr>Feature</a></li>
								<li class="tsd-kind-class"><a href="classes/Revoked.html" class="tsd-kind-icon">Revoked</a></li>
								<li class="tsd-kind-class"><a href="classes/UserTokenExpiry.html" class="tsd-kind-icon">User<wbr>Token<wbr>Expiry</a></li>
							</ul>
						</section>
						<section class="tsd-index-section ">
							<h3>Type aliases</h3>
							<ul class="tsd-index-list">
								<li class="tsd-kind-type-alias tsd-has-type-parameter"><a href="index.html#DeepPartial" class="tsd-kind-icon">Deep<wbr>Partial</a></li>
						...
						<section class="tsd-index-section ">
							<h3>Variables</h3>
							<ul class="tsd-index-list">
								<li class="tsd-kind-variable"><a href="index.html#DEFAULT_DERIVATION_SEED" class="tsd-kind-icon">DEFAULT_<wbr>DERIVATION_<wbr>SEED</a></li>
								<li class="tsd-kind-variable"><a href="index.html#DEFAULT_SOLANA_RETRIES" class="tsd-kind-icon">DEFAULT_<wbr>SOLANA_<wbr>RETRIES</a></li>
								<li class="tsd-kind-variable"><a href="index.html#GATEKEEPER_NONCE_SEED_STRING" class="tsd-kind-icon">GATEKEEPER_<wbr>NONCE_<wbr>SEED_<wbr>STRING</a></li>
								<li class="tsd-kind-variable"><a href="index.html#GATEWAY_TOKEN_ACCOUNT_GATEKEEPER_NETWORK_FIELD_OFFSET" class="tsd-kind-icon">GATEWAY_<wbr>TOKEN_<wbr>ACCOUNT_<wbr>GATEKEEPER_<wbr>NETWORK_<wbr>FIELD_<wbr>OFFSET</a></li>
								<li class="tsd-kind-variable"><a href="index.html#GATEWAY_TOKEN_ACCOUNT_OWNER_FIELD_OFFSET" class="tsd-kind-icon">GATEWAY_<wbr>TOKEN_<wbr>ACCOUNT_<wbr>OWNER_<wbr>FIELD_<wbr>OFFSET</a></li>
								<li class="tsd-kind-variable"><a href="index.html#GATEWAY_TOKEN_ADDRESS_SEED" class="tsd-kind-icon">GATEWAY_<wbr>TOKEN_<wbr>ADDRESS_<wbr>SEED</a></li>
								<li class="tsd-kind-variable"><a href="index.html#PROGRAM_ID" class="tsd-kind-icon">PROGRAM_<wbr>ID</a></li>
								<li class="tsd-kind-variable"><a href="index.html#SOLANA_COMMITMENT" class="tsd-kind-icon">SOLANA_<wbr>COMMITMENT</a></li>
								<li class="tsd-kind-variable"><a href="index.html#SOLANA_TIMEOUT_CONFIRMED" class="tsd-kind-icon">SOLANA_<wbr>TIMEOUT_<wbr>CONFIRMED</a></li>
								<li class="tsd-kind-variable"><a href="index.html#SOLANA_TIMEOUT_FINALIZED" class="tsd-kind-icon">SOLANA_<wbr>TIMEOUT_<wbr>FINALIZED</a></li>
								<li class="tsd-kind-variable"><a href="index.html#SOLANA_TIMEOUT_PROCESSED" class="tsd-kind-icon">SOLANA_<wbr>TIMEOUT_<wbr>PROCESSED</a></li>
							</ul>
						</section>
						<section class="tsd-index-section ">
							<h3>Functions</h3>
							<ul class="tsd-index-list">
								<li class="tsd-kind-function"><a href="index.html#addFeatureToNetwork" class="tsd-kind-icon">add<wbr>Feature<wbr>ToNetwork</a></li>
								...
								<li class="tsd-kind-function"><a href="index.html#featureExists" class="tsd-kind-icon">feature<wbr>Exists</a></li>
								...
								<li class="tsd-kind-function"><a href="index.html#findGatewayTokensForOwnerAndNetwork" class="tsd-kind-icon">find<wbr>Gateway<wbr>Tokens<wbr>For<wbr>Owner<wbr>And<wbr>Network</a></li>
								...
								<li class="tsd-kind-function"><a href="index.html#getFeatureAccountAddress" class="tsd-kind-icon">get<wbr>Feature<wbr>Account<wbr>Address</a></li>
								<li class="tsd-kind-function"><a href="index.html#getGatekeeperAccountAddress" class="tsd-kind-icon">get<wbr>Gatekeeper<wbr>Account<wbr>Address</a></li>
								<li class="tsd-kind-function"><a href="index.html#getGatewayToken" class="tsd-kind-icon">get<wbr>Gateway<wbr>Token</a></li>
								<li class="tsd-kind-function"><a href="index.html#getGatewayTokenAddressForOwnerAndGatekeeperNetwork" class="tsd-kind-icon">get<wbr>Gateway<wbr>Token<wbr>Address<wbr>For<wbr>Owner<wbr>And<wbr>Gatekeeper<wbr>Network</a></li>
								<li class="tsd-kind-function"><a href="index.html#issueVanilla" class="tsd-kind-icon">issue<wbr>Vanilla</a></li>
								<li class="tsd-kind-function"><a href="index.html#mapEnumToFeatureName" class="tsd-kind-icon">map<wbr>Enum<wbr>ToFeature<wbr>Name</a></li>
								<li class="tsd-kind-function"><a href="index.html#numToBuffer" class="tsd-kind-icon">num<wbr>ToBuffer</a></li>
								<li class="tsd-kind-function"><a href="index.html#onGatewayToken" class="tsd-kind-icon">on<wbr>Gateway<wbr>Token</a></li>
								...
								<li class="tsd-kind-function"><a href="index.html#removeAccountChangeListener" class="tsd-kind-icon">remove<wbr>Account<wbr>Change<wbr>Listener</a></li>
								<li class="tsd-kind-function"><a href="index.html#removeFeatureFromNetwork" class="tsd-kind-icon">remove<wbr>Feature<wbr>From<wbr>Network</a></li>
			...
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-type-alias tsd-has-type-parameter">
					<a name="DeepPartial" class="tsd-anchor"></a>
					<h3>Deep<wbr>Partial</h3>
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/types/index.ts#L5">types/index.ts:5</a></li>
						</ul>
					</aside>
				...
				<section class="tsd-panel tsd-member tsd-kind-type-alias">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/types/index.ts#L62">types/index.ts:62</a></li>
						</ul>
					</aside>
			...
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-variable">
					<a name="DEFAULT_DERIVATION_SEED" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagConst">Const</span> DEFAULT_<wbr>DERIVATION_<wbr>SEED</h3>
					<div class="tsd-signature tsd-kind-icon">DEFAULT_<wbr>DERIVATION_<wbr>SEED<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">Buffer</span><span class="tsd-signature-symbol"> = ...</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/constants.ts#L16">lib/constants.ts:16</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-variable">
					<a name="DEFAULT_SOLANA_RETRIES" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagConst">Const</span> DEFAULT_<wbr>SOLANA_<wbr>RETRIES</h3>
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/constants.ts#L11">lib/constants.ts:11</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-variable">
					<a name="GATEKEEPER_NONCE_SEED_STRING" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagConst">Const</span> GATEKEEPER_<wbr>NONCE_<wbr>SEED_<wbr>STRING</h3>
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/constants.ts#L7">lib/constants.ts:7</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-variable">
					<a name="GATEWAY_TOKEN_ACCOUNT_GATEKEEPER_NETWORK_FIELD_OFFSET" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagConst">Const</span> GATEWAY_<wbr>TOKEN_<wbr>ACCOUNT_<wbr>GATEKEEPER_<wbr>NETWORK_<wbr>FIELD_<wbr>OFFSET</h3>
					<div class="tsd-signature tsd-kind-icon">GATEWAY_<wbr>TOKEN_<wbr>ACCOUNT_<wbr>GATEKEEPER_<wbr>NETWORK_<wbr>FIELD_<wbr>OFFSET<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">35</span><span class="tsd-signature-symbol"> = 35</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/util.ts#L75">lib/util.ts:75</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-variable">
					<a name="GATEWAY_TOKEN_ACCOUNT_OWNER_FIELD_OFFSET" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagConst">Const</span> GATEWAY_<wbr>TOKEN_<wbr>ACCOUNT_<wbr>OWNER_<wbr>FIELD_<wbr>OFFSET</h3>
					<div class="tsd-signature tsd-kind-icon">GATEWAY_<wbr>TOKEN_<wbr>ACCOUNT_<wbr>OWNER_<wbr>FIELD_<wbr>OFFSET<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">2</span><span class="tsd-signature-symbol"> = 2</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/util.ts#L72">lib/util.ts:72</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-variable">
					<a name="GATEWAY_TOKEN_ADDRESS_SEED" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagConst">Const</span> GATEWAY_<wbr>TOKEN_<wbr>ADDRESS_<wbr>SEED</h3>
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/constants.ts#L8">lib/constants.ts:8</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-variable">
					<a name="PROGRAM_ID" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagConst">Const</span> PROGRAM_<wbr>ID</h3>
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/constants.ts#L4">lib/constants.ts:4</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-variable">
					<a name="SOLANA_COMMITMENT" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagConst">Const</span> SOLANA_<wbr>COMMITMENT</h3>
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/constants.ts#L10">lib/constants.ts:10</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-variable">
					<a name="SOLANA_TIMEOUT_CONFIRMED" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagConst">Const</span> SOLANA_<wbr>TIMEOUT_<wbr>CONFIRMED</h3>
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/constants.ts#L14">lib/constants.ts:14</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-variable">
					<a name="SOLANA_TIMEOUT_FINALIZED" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagConst">Const</span> SOLANA_<wbr>TIMEOUT_<wbr>FINALIZED</h3>
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/constants.ts#L15">lib/constants.ts:15</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-variable">
					<a name="SOLANA_TIMEOUT_PROCESSED" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagConst">Const</span> SOLANA_<wbr>TIMEOUT_<wbr>PROCESSED</h3>
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/constants.ts#L13">lib/constants.ts:13</a></li>
						</ul>
					</aside>
				</section>
			</section>
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					<a name="addFeatureToNetwork" class="tsd-anchor"></a>
					<h3>add<wbr>Feature<wbr>ToNetwork</h3>
					<ul class="tsd-signatures tsd-kind-function">
						<li class="tsd-signature tsd-kind-icon">add<wbr>Feature<wbr>ToNetwork<span class="tsd-signature-symbol">(</span>payer<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">PublicKey</span>, network<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">PublicKey</span>, feature<span class="tsd-signature-symbol">: </span><a href="classes/NetworkFeature.html" class="tsd-signature-type" data-tsd-kind="Class">NetworkFeature</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">TransactionInstruction</span><span class="tsd-signature-symbol">&gt;</span></li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/instruction.ts#L338">lib/instruction.ts:338</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
									<p>Add a feature to an existing Gatekeeper Network.
							...
							<ul class="tsd-parameters">
								...
								<li>
									...
									<div class="tsd-comment tsd-typography">
										<p>The NetworkFeature Enum value</p>
									</div>
								</li>
							</ul>
							<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">TransactionInstruction</span><span class="tsd-signature-symbol">&gt;</span></h4>
						</li>
					</ul>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-function">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/instruction.ts#L127">lib/instruction.ts:127</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/util.ts#L85">lib/util.ts:85</a></li>
								</ul>
							</aside>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					<a name="featureExists" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagConst">Const</span> feature<wbr>Exists</h3>
					<ul class="tsd-signatures tsd-kind-function">
						<li class="tsd-signature tsd-kind-icon">feature<wbr>Exists<span class="tsd-signature-symbol">(</span>connection<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Connection</span>, feature<span class="tsd-signature-symbol">: </span><a href="classes/NetworkFeature.html" class="tsd-signature-type" data-tsd-kind="Class">NetworkFeature</a>, network<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">PublicKey</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">&gt;</span></li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/index.ts#L276">index.ts:276</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
									<p>Return true if an address feature exists.</p>
								</div>
							</div>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/index.ts#L173">index.ts:173</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
									<p>Get a gateway token for the owner and network, if it exists.</p>
								</div>
							</div>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/index.ts#L47">index.ts:47</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
							...
							<ul class="tsd-parameters">
								...
								<li>
									...
									<div class="tsd-comment tsd-typography">
										<p>If a large number of tokens has been issued, the request to the RPC endpoint may time out.
										...
										Each page requests the accounts that match that byte.</p>
									</div>
								</li>
							</ul>
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					<a name="findGatewayTokensForOwnerAndNetwork" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagConst">Const</span> find<wbr>Gateway<wbr>Tokens<wbr>For<wbr>Owner<wbr>And<wbr>Network</h3>
					<ul class="tsd-signatures tsd-kind-function">
						<li class="tsd-signature tsd-kind-icon">find<wbr>Gateway<wbr>Tokens<wbr>For<wbr>Owner<wbr>And<wbr>Network<span class="tsd-signature-symbol">(</span>connection<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Connection</span>, owner<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">PublicKey</span>, gatekeeperNetwork<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">PublicKey</span>, includeRevoked<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span>, offset<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">number</span>, page<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="classes/GatewayToken.html" class="tsd-signature-type" data-tsd-kind="Class">GatewayToken</a><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">&gt;</span></li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/index.ts#L118">index.ts:118</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
									<p>Finds all gateway tokens for a user by iterating through the index seed
									and requesting a page of addresses at a time.</p>
								</div>
								<p>It assumes a small number of passes per GKN, so the page size by default is 5.
								Sorts the result by active status and expiry, so unexpired active passes appear first</p>
							</div>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
								<li>
								...
								<li>
									<h5>page: <span class="tsd-signature-type">number</span><span class="tsd-signature-symbol"> = 5</span></h5>
									<div class="tsd-comment tsd-typography">
									</div>
								</li>
							</ul>
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/instruction.ts#L261">lib/instruction.ts:261</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/util.ts#L115">lib/util.ts:115</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					<a name="getFeatureAccountAddress" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagConst">Const</span> get<wbr>Feature<wbr>Account<wbr>Address</h3>
					<ul class="tsd-signatures tsd-kind-function">
						<li class="tsd-signature tsd-kind-icon">get<wbr>Feature<wbr>Account<wbr>Address<span class="tsd-signature-symbol">(</span>feature<span class="tsd-signature-symbol">: </span><a href="classes/NetworkFeature.html" class="tsd-signature-type" data-tsd-kind="Class">NetworkFeature</a>, network<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">PublicKey</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">PublicKey</span></li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/util.ts#L157">lib/util.ts:157</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
									<p>Derive the address of the feature PDA</p>
								</div>
							</div>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					<a name="getGatekeeperAccountAddress" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagConst">Const</span> get<wbr>Gatekeeper<wbr>Account<wbr>Address</h3>
					<ul class="tsd-signatures tsd-kind-function">
						<li class="tsd-signature tsd-kind-icon">get<wbr>Gatekeeper<wbr>Account<wbr>Address<span class="tsd-signature-symbol">(</span>authority<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">PublicKey</span>, network<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">PublicKey</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">PublicKey</span></li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/util.ts#L17">lib/util.ts:17</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/index.ts#L253">index.ts:253</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					<a name="getGatewayTokenAddressForOwnerAndGatekeeperNetwork" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagConst">Const</span> get<wbr>Gateway<wbr>Token<wbr>Address<wbr>For<wbr>Owner<wbr>And<wbr>Gatekeeper<wbr>Network</h3>
					<ul class="tsd-signatures tsd-kind-function">
						<li class="tsd-signature tsd-kind-icon">get<wbr>Gateway<wbr>Token<wbr>Address<wbr>For<wbr>Owner<wbr>And<wbr>Gatekeeper<wbr>Network<span class="tsd-signature-symbol">(</span>owner<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">PublicKey</span>, gatekeeperNetwork<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">PublicKey</span>, index<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">PublicKey</span></li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/util.ts#L36">lib/util.ts:36</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
							...
							<ul class="tsd-parameters">
								...
								<li>
									<h5>index: <span class="tsd-signature-type">number</span><span class="tsd-signature-symbol"> = 0</span></h5>
									<div class="tsd-comment tsd-typography">
										<p>The index of the gateway token (default 0)</p>
									</div>
								</li>
							</ul>
							<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">PublicKey</span></h4>
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/instruction.ts#L191">lib/instruction.ts:191</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
							...
							<ul class="tsd-parameters">
								<li>
									<h5>gatewayTokenAccount: <span class="tsd-signature-type">PublicKey</span></h5>
									<div class="tsd-comment tsd-typography">
										<p>An uninitialised gateway token account PDA. The address must be derived via getGatewayTokenAddressForOwnerAndGatekeeperNetwork</p>
									</div>
								</li>
								<li>
									<h5>payer: <span class="tsd-signature-type">PublicKey</span></h5>
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					<a name="mapEnumToFeatureName" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagConst">Const</span> map<wbr>Enum<wbr>ToFeature<wbr>Name</h3>
					<ul class="tsd-signatures tsd-kind-function">
						<li class="tsd-signature tsd-kind-icon">map<wbr>Enum<wbr>ToFeature<wbr>Name<span class="tsd-signature-symbol">(</span>enumValue<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/GatewayNetworkData.ts#L15">lib/GatewayNetworkData.ts:15</a></li>
								</ul>
							</aside>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
								<li>
									<h5>enumValue: <span class="tsd-signature-type">string</span></h5>
								</li>
							</ul>
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					<a name="numToBuffer" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagConst">Const</span> num<wbr>ToBuffer</h3>
					<ul class="tsd-signatures tsd-kind-function">
						<li class="tsd-signature tsd-kind-icon">num<wbr>ToBuffer<span class="tsd-signature-symbol">(</span>num<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Buffer</span></li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/util.ts#L137">lib/util.ts:137</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
									<p>Converts a number to a buffer of U8 integers, for use in the gateway token address
									derivation as the seed value.</p>
								</div>
							</div>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					<a name="onGatewayToken" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagConst">Const</span> on<wbr>Gateway<wbr>Token</h3>
					<ul class="tsd-signatures tsd-kind-function">
						<li class="tsd-signature tsd-kind-icon">on<wbr>Gateway<wbr>Token<span class="tsd-signature-symbol">(</span>connection<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Connection</span>, owner<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">PublicKey</span>, gatekeeperNetwork<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">PublicKey</span>, callback<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">(</span>gatewayToken<span class="tsd-signature-symbol">: </span><a href="classes/GatewayToken.html" class="tsd-signature-type" data-tsd-kind="Class">GatewayToken</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type">void</span>, commitment<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">Commitment</span>, seed<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span></li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/index.ts#L225">index.ts:225</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
									<p>Register a callback to be called whenever a gateway token is created or changes state</p>
								</div>
							</div>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
								...
								<li>
									<h5>seed: <span class="tsd-signature-type">number</span><span class="tsd-signature-symbol"> = 0</span></h5>
								</li>
							</ul>
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					...
					<ul class="tsd-signatures tsd-kind-function">
						<li class="tsd-signature tsd-kind-icon">on<wbr>Gateway<wbr>Token<wbr>Change<span class="tsd-signature-symbol">(</span>connection<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Connection</span>, gatewayTokenAddress<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">PublicKey</span>, callback<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">(</span>gatewayToken<span class="tsd-signature-symbol">: </span><a href="classes/GatewayToken.html" class="tsd-signature-type" data-tsd-kind="Class">GatewayToken</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type">void</span>, commitment<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">Commitment</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span></li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/index.ts#L195">index.ts:195</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					...
					<h3><span class="tsd-flag ts-flagConst">Const</span> remove<wbr>Account<wbr>Change<wbr>Listener</h3>
					<ul class="tsd-signatures tsd-kind-function">
						<li class="tsd-signature tsd-kind-icon">remove<wbr>Account<wbr>Change<wbr>Listener<span class="tsd-signature-symbol">(</span>connection<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Connection</span>, id<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/util.ts#L104">lib/util.ts:104</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
									<p>Stops listening to gateway state changes</p>
								</div>
							</div>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
								...
								<li>
									...
									<div class="tsd-comment tsd-typography">
										<p>The subscription id to deregister</p>
									</div>
								</li>
							</ul>
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					<a name="removeFeatureFromNetwork" class="tsd-anchor"></a>
					<h3>remove<wbr>Feature<wbr>From<wbr>Network</h3>
					<ul class="tsd-signatures tsd-kind-function">
						<li class="tsd-signature tsd-kind-icon">remove<wbr>Feature<wbr>From<wbr>Network<span class="tsd-signature-symbol">(</span>payer<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">PublicKey</span>, network<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">PublicKey</span>, feature<span class="tsd-signature-symbol">: </span><a href="classes/NetworkFeature.html" class="tsd-signature-type" data-tsd-kind="Class">NetworkFeature</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">TransactionInstruction</span><span class="tsd-signature-symbol">&gt;</span></li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/instruction.ts#L366">lib/instruction.ts:366</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
									<p>Remove a feature to an existing Gatekeeper Network.
									Returns a Solana instruction that must be signed by the gatekeeper authority.</p>
								</div>
							</div>
							<h4 class="tsd-parameters-title">Parameters</h4>
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/instruction.ts#L236">lib/instruction.ts:236</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/instruction.ts#L158">lib/instruction.ts:158</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/instruction.ts#L286">lib/instruction.ts:286</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
				...
				<section class="tsd-panel tsd-member tsd-kind-function">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/identity-com/on-chain-identity-gateway/blob/0140959/solana/gateway-ts/src/lib/instruction.ts#L312">lib/instruction.ts:312</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
		...
		<div class="col-4 col-menu menu-sticky-wrap menu-highlight">
			...
			<nav class="tsd-navigation secondary menu-sticky">
				<ul class="before-current">
					...
					<li class=" tsd-kind-class">
						<a href="classes/AssignablePublicKey.html" class="tsd-kind-icon">Assignable<wbr>Public<wbr>Key</a>
					</li>
					<li class=" tsd-kind-class">
					...
					<li class=" tsd-kind-class">
						<a href="classes/NetworkFeature.html" class="tsd-kind-icon">Network<wbr>Feature</a>
					</li>
					<li class=" tsd-kind-class">
						<a href="classes/Revoked.html" class="tsd-kind-icon">Revoked</a>
					</li>
					<li class=" tsd-kind-class">
						<a href="classes/UserTokenExpiry.html" class="tsd-kind-icon">User<wbr>Token<wbr>Expiry</a>
					</li>
					<li class=" tsd-kind-type-alias tsd-has-type-parameter">
						<a href="index.html#DeepPartial" class="tsd-kind-icon">Deep<wbr>Partial</a>
					</li>
					<li class=" tsd-kind-type-alias">
						<a href="index.html#ProgramAccountResponse" class="tsd-kind-icon">Program<wbr>Account<wbr>Response</a>
					</li>
					<li class=" tsd-kind-variable">
						<a href="index.html#DEFAULT_DERIVATION_SEED" class="tsd-kind-icon">DEFAULT_<wbr>DERIVATION_<wbr>SEED</a>
					</li>
					<li class=" tsd-kind-variable">
						<a href="index.html#DEFAULT_SOLANA_RETRIES" class="tsd-kind-icon">DEFAULT_<wbr>SOLANA_<wbr>RETRIES</a>
					</li>
					<li class=" tsd-kind-variable">
						<a href="index.html#GATEKEEPER_NONCE_SEED_STRING" class="tsd-kind-icon">GATEKEEPER_<wbr>NONCE_<wbr>SEED_<wbr>STRING</a>
					</li>
					<li class=" tsd-kind-variable">
						<a href="index.html#GATEWAY_TOKEN_ACCOUNT_GATEKEEPER_NETWORK_FIELD_OFFSET" class="tsd-kind-icon">GATEWAY_<wbr>TOKEN_<wbr>ACCOUNT_<wbr>GATEKEEPER_<wbr>NETWORK_<wbr>FIELD_<wbr>OFFSET</a>
					</li>
					<li class=" tsd-kind-variable">
						<a href="index.html#GATEWAY_TOKEN_ACCOUNT_OWNER_FIELD_OFFSET" class="tsd-kind-icon">GATEWAY_<wbr>TOKEN_<wbr>ACCOUNT_<wbr>OWNER_<wbr>FIELD_<wbr>OFFSET</a>
					</li>
					<li class=" tsd-kind-variable">
						<a href="index.html#GATEWAY_TOKEN_ADDRESS_SEED" class="tsd-kind-icon">GATEWAY_<wbr>TOKEN_<wbr>ADDRESS_<wbr>SEED</a>
					</li>
					<li class=" tsd-kind-variable">
						<a href="index.html#PROGRAM_ID" class="tsd-kind-icon">PROGRAM_<wbr>ID</a>
					</li>
					<li class=" tsd-kind-variable">
						<a href="index.html#SOLANA_COMMITMENT" class="tsd-kind-icon">SOLANA_<wbr>COMMITMENT</a>
					</li>
					<li class=" tsd-kind-variable">
						<a href="index.html#SOLANA_TIMEOUT_CONFIRMED" class="tsd-kind-icon">SOLANA_<wbr>TIMEOUT_<wbr>CONFIRMED</a>
					</li>
					<li class=" tsd-kind-variable">
						<a href="index.html#SOLANA_TIMEOUT_FINALIZED" class="tsd-kind-icon">SOLANA_<wbr>TIMEOUT_<wbr>FINALIZED</a>
					</li>
					<li class=" tsd-kind-variable">
						<a href="index.html#SOLANA_TIMEOUT_PROCESSED" class="tsd-kind-icon">SOLANA_<wbr>TIMEOUT_<wbr>PROCESSED</a>
					</li>
					<li class=" tsd-kind-function">
						<a href="index.html#addFeatureToNetwork" class="tsd-kind-icon">add<wbr>Feature<wbr>ToNetwork</a>
					</li>
					<li class=" tsd-kind-function">
					...
					<li class=" tsd-kind-function">
						<a href="index.html#featureExists" class="tsd-kind-icon">feature<wbr>Exists</a>
					</li>
					<li class=" tsd-kind-function">
					...
					<li class=" tsd-kind-function">
						<a href="index.html#findGatewayTokensForOwnerAndNetwork" class="tsd-kind-icon">find<wbr>Gateway<wbr>Tokens<wbr>For<wbr>Owner<wbr>And<wbr>Network</a>
					</li>
					<li class=" tsd-kind-function">
					...
					<li class=" tsd-kind-function">
						<a href="index.html#getFeatureAccountAddress" class="tsd-kind-icon">get<wbr>Feature<wbr>Account<wbr>Address</a>
					</li>
					<li class=" tsd-kind-function">
						<a href="index.html#getGatekeeperAccountAddress" class="tsd-kind-icon">get<wbr>Gatekeeper<wbr>Account<wbr>Address</a>
					</li>
					<li class=" tsd-kind-function">
						<a href="index.html#getGatewayToken" class="tsd-kind-icon">get<wbr>Gateway<wbr>Token</a>
					</li>
					<li class=" tsd-kind-function">
						<a href="index.html#getGatewayTokenAddressForOwnerAndGatekeeperNetwork" class="tsd-kind-icon">get<wbr>Gateway<wbr>Token<wbr>Address<wbr>For<wbr>Owner<wbr>And<wbr>Gatekeeper<wbr>Network</a>
					</li>
					<li class=" tsd-kind-function">
						<a href="index.html#issueVanilla" class="tsd-kind-icon">issue<wbr>Vanilla</a>
					</li>
					<li class=" tsd-kind-function">
						<a href="index.html#mapEnumToFeatureName" class="tsd-kind-icon">map<wbr>Enum<wbr>ToFeature<wbr>Name</a>
					</li>
					<li class=" tsd-kind-function">
						<a href="index.html#numToBuffer" class="tsd-kind-icon">num<wbr>ToBuffer</a>
					</li>
					<li class=" tsd-kind-function">
						<a href="index.html#onGatewayToken" class="tsd-kind-icon">on<wbr>Gateway<wbr>Token</a>
					</li>
					<li class=" tsd-kind-function">
						<a href="index.html#onGatewayTokenChange" class="tsd-kind-icon">on<wbr>Gateway<wbr>Token<wbr>Change</a>
					</li>
					<li class=" tsd-kind-function">
						<a href="index.html#removeAccountChangeListener" class="tsd-kind-icon">remove<wbr>Account<wbr>Change<wbr>Listener</a>
					</li>
					<li class=" tsd-kind-function">
						<a href="index.html#removeFeatureFromNetwork" class="tsd-kind-icon">remove<wbr>Feature<wbr>From<wbr>Network</a>
					</li>
					<li class=" tsd-kind-function">
